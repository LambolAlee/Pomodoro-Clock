...
class Ui_Dialog(object):
    def setupUi(self, version, Dialog):
        ...
        self.label_2.setGeometry(QtCore.QRect(180, 70, 411, 91))
        font = QtGui.QFont()
